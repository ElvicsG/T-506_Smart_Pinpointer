...
import static com.kehui.www.testapp.ui.KBubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.kehui.www.testapp.ui.KBubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.kehui.www.testapp.ui.KBubbleSeekBar.TextPosition.SIDES;
import static com.kehui.www.testapp.ui.KBubbleUtils.dp2px;
import static com.kehui.www.testapp.ui.KBubbleUtils.sp2px;
 ...
 * BubbleSeekBar Created by woxingxiao on 2016-10-27.   //GC20220620
 */
public class KBubbleSeekBar extends View {
    ...
    public KBubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //滑轨大小  //GC20220620
        mTrackSize = ta.getDimensionPixelSize(R.styleable.KBubbleSeekBar_bsb_track_size, dp2px(22));
        ...
        //拇指颜色  //GC20220620
        mThumbColor = ta.getColor(R.styleable.KBubbleSeekBar_bsb_thumb_color, ContextCompat.getColor(context, R.color.white));
        ...
        //触摸轨道上的任意位置以快速移动   //GC20220620
        isTouchToSeek = ta.getBoolean(R.styleable.KBubbleSeekBar_bsb_touch_to_seek, true);
        ...
        //气泡显示隐藏    //GC20220620
        isHideBubble = ta.getBoolean(R.styleable.KBubbleSeekBar_bsb_hide_bubble, true);
        ...
        if (colorStr == null || colorStr.equals("")) {
            colorStr = "#ffEEEE00_#ffe1992e_#CD0000";   //渐变色号  //GC20220620
        }
